...
public class EmailTemplateValidator {
    ...
    public void modifyEmailTemplateValidate(ModifyEmailTemplateRequest req) {
        /* Check email template existence in ses */
        EmailTemplate existingTemplate = sesUtils.loadEmailTemplate(req.getTemplateName());
        if (existingTemplate == null) {
            throw new CustomValidationException(1, "Email template does not exist in SES.");
        }
